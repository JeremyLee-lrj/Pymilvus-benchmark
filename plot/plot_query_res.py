...
with open("../res/query_ls_res.json", "r") as file:
    data1 = json.load(file)
with open("../res/query_gt_res.json", "r") as file:
...
plt.ylabel(u'query time cost', fontsize=18)
# 标题
plt.title(u'query time cost with different threshold', fontsize=18)
# 图例
plt.legend(fontsize=18)
# 保存图片
plt.savefig('./query_lt_and_gt_res_figure.png', bbox_inches='tight')
# 显示图片
plt.show()
